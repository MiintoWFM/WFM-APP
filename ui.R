      ...
      tabItems(
        ...
        tabItem(tabName = "coverage",
                ...
                box(tabBox(id = "tabset_projects",width = 12,
                           ...
                           tabPanel("Phone Native", icon = icon("phone-alt"),textOutput("Phone native"),
                                    fluidRow(
                           ...
                           tabPanel("Phone ENG", icon = icon("phone-alt"),textOutput("Phone Eng"),
                                    fluidRow(
                                      column(6,plotlyOutput('day_1_5')),
                                      column(6,plotlyOutput('day_2_5'))

                                    ),
                                    fluidRow(
                                      column(4,plotlyOutput('day_3_5')),
                                      column(4,plotlyOutput('day_4_5')),
                                      column(4,plotlyOutput('day_5_5'))

                                    ),
                                    fluidRow(
                                      column(6,plotlyOutput('day_6_5')),
                                      column(6,plotlyOutput('day_7_5'))
