...
# data_delivered <- read.csv(url("https://raw.githubusercontent.com/tesfahunboshe/Workforce-Management-App-with-Shiny/main/Data/delivered.csv"))

data_schedule <- read.csv("C:\\Users\\Tesfahun Boshe\\Documents\\WFM\\NewAPp\\Data\\schedule.csv")
data_coverage <- read.csv("C:\\Users\\Tesfahun Boshe\\Documents\\WFM\\NewAPp\\Data\\coverage.csv")
data_requirement <- read.csv("C:\\Users\\Tesfahun Boshe\\Documents\\WFM\\NewAPp\\Data\\requirement.csv")
data_delivered <- read.csv("C:\\Users\\Tesfahun Boshe\\Documents\\WFM\\NewAPp\\Data\\delivered.csv")
